    ...
    <div className="User">
      ...
      <div className="inner-div">
        ...
        <div className="user-links">
          ...
          <a href={account.portfolio} rel="noreferrer" target="_blank">
            Portfolio link
          </a>
          &nbsp;&nbsp;
        ...
        <Link className="edit-page-btn" to={`/user/${user._id}/edit`}>
          Edit Profile
        </Link>
      </div>
                ...
                <section className="post" key={post._id}>
                  <div className="posted-user-details">
                    <div>
                      ...
                      <div>
                        <p className="user-details">{post.name}</p>
                        <p className="user-details">
                          {post.cohort ? post.cohort : "no coh"}
                        </p>
                      </div>
                    </div>
                  </div>
